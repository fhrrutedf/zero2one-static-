        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <a href="https://www.instagram.com/zero2onedm/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 sm:w-9 sm:h-9 flex items-center justify-center rounded-full bg-white/10 text-white/70 hover:bg-brand hover:text-white transition-all duration-300 min-w-[44px] min-h-[44px]">
                <Instagram size={14} className="sm:w-4 sm:h-4" />
              </a>
              <a href="https://x.com/Zero2OneDM" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="w-9 h-9 sm:w-9 sm:h-9 flex items-center justify-center rounded-full bg-white/10 text-white/70 hover:bg-brand hover:text-white transition-all duration-300 min-w-[44px] min-h-[44px]">
              ...
              <a href="https://www.tiktok.com/@zero2one2030" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-9 h-9 sm:w-9 sm:h-9 flex items-center justify-center rounded-full bg-white/10 text-white/70 hover:bg-brand hover:text-white transition-all duration-300 min-w-[44px] min-h-[44px]">
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <a href="tel:+966530307054" className="text-white/60 hover:text-brand transition-colors text-xs sm:text-sm">
                  +966 53 030 7054
                </a>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
