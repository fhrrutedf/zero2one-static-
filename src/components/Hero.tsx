    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center section-dark overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 sm:py-0">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-lg lg:text-xl max-w-xl sm:max-w-2xl mx-auto mb-8 sm:mb-12 leading-relaxed px-2 animate-fade-in-up delay-400 text-white/60">
            {t('hero_subtitle')}
          </p>
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 lg:gap-12 max-w-md sm:max-w-xl mx-auto animate-fade-in-up delay-700">
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm mt-0.5 sm:mt-1 text-white/50">{t('about_stats_projects')}</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm mt-0.5 sm:mt-1 text-white/50">{t('about_stats_clients')}</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm mt-0.5 sm:mt-1 text-white/50">{t('about_stats_experience')}</div>
            </div>
          </div>
        </div>
      </div>
