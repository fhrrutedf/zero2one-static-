...
export default function Services() {
  ...
  return (
    <section id="services" ref={sectionRef} className="py-14 sm:py-20 lg:py-28 bg-white">
          ...
          {services.map((service, idx) => {
            ...
            return (
              <div
                ...
                className={`card-hover bg-card-bg rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 ${visible ? 'animate-fade-in-up' : 'opacity-0'}`}
                style={{ animationDelay: `${idx * 100}ms` }}
              >
                <div className="service-icon mb-4 sm:mb-5">
                  <Icon size={24} className="text-gold sm:w-8 sm:h-8" />
                </div>
