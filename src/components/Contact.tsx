          ...
          <div className={`${visible ? (isRTL ? 'animate-fade-in-left' : 'animate-fade-in-right') : 'opacity-0'}`}>
            ...
            <div className="mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-border">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <a href="https://www.instagram.com/zero2onedm/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-card-bg text-muted-foreground hover:bg-brand hover:text-white transition-all duration-300 min-w-[44px] min-h-[44px]">
                  <Instagram size={16} className="sm:w-[18px] sm:h-[18px]" />
                </a>
                <a href="https://x.com/Zero2OneDM" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-card-bg text-muted-foreground hover:bg-brand hover:text-white transition-all duration-300 min-w-[44px] min-h-[44px]">
                ...
                <a href="https://www.tiktok.com/@zero2one2030" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-card-bg text-muted-foreground hover:bg-brand hover:text-white transition-all duration-300 min-w-[44px] min-h-[44px]">
