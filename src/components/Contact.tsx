            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border border-border bg-light-bg text-foreground text-sm placeholder:text-muted-foreground focus:border-gold focus:ring-2 focus:ring-gold/15 transition-all duration-300"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border border-border bg-light-bg text-foreground text-sm placeholder:text-muted-foreground focus:border-gold focus:ring-2 focus:ring-gold/15 transition-all duration-300 resize-none"
                  required
                />
              </div>
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-gold text-white font-semibold text-base sm:text-lg hover:bg-gold-dark transition-all duration-300 shadow-lg shadow-gold/25 hover:shadow-gold/40 min-h-[48px]"
              >
          ...
          <div className={`${visible ? 'animate-fade-in-left' : 'opacity-0'}`}>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-card-bg">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gold/10 flex items-center justify-center shrink-0">
                  <MapPin size={16} className="text-gold sm:w-[18px] sm:h-[18px]" />
                </div>
                <div>
                  <h4 className="font-semibold text-foreground text-xs sm:text-sm">{t('contact_address')}</h4>
                  <p className="text-muted-foreground text-[10px] sm:text-xs mt-0.5">{t('contact_address')}</p>
                </div>
              </div>

              <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-card-bg">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gold/10 flex items-center justify-center shrink-0">
                  <Phone size={16} className="text-gold sm:w-[18px] sm:h-[18px]" />
                </div>
                <div>
                  <h4 className="font-semibold text-foreground text-xs sm:text-sm">{t('contact_phone_num')}</h4>
                  <a href="tel:+966500000000" className="text-muted-foreground text-[10px] sm:text-xs mt-0.5 hover:text-gold transition-colors">
                    {t('contact_phone_num')}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-card-bg">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gold/10 flex items-center justify-center shrink-0">
                  <Mail size={16} className="text-gold sm:w-[18px] sm:h-[18px]" />
                </div>
                <div>
                  <h4 className="font-semibold text-foreground text-xs sm:text-sm">{t('contact_email_addr')}</h4>
                  <a href="mailto:info@shirkatak.com" className="text-muted-foreground text-[10px] sm:text-xs mt-0.5 hover:text-gold transition-colors">
            ...
            <div className="mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-border">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-card-bg text-muted-foreground hover:bg-gold hover:text-white transition-all duration-300 min-w-[44px] min-h-[44px]">
