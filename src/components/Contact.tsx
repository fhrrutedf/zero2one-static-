          ...
          <div className={`${visible ? (isRTL ? 'animate-fade-in-left' : 'animate-fade-in-right') : 'opacity-0'}`}>
            ...
            <div className="mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-border">
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                ...
                <a href="https://www.youtube.com/@zero2one2030" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white border border-border text-foreground/60 hover:bg-[#bc8934] hover:text-white hover:border-[#bc8934] transition-all duration-300 min-w-[44px] min-h-[44px]">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="sm:w-[18px] sm:h-[18px]"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                <a href="https://www.linkedin.com/company/zero2onedm" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white border border-border text-foreground/60 hover:bg-[#bc8934] hover:text-white hover:border-[#bc8934] transition-all duration-300 min-w-[44px] min-h-[44px]">
