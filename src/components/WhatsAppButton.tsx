...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      <span className="absolute bottom-full start-0 mb-2 px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs font-semibold text-white bg-[#25D366] rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-lg">
        {t('whatsapp_tooltip')}
      </span>
      <div className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/50 hover:scale-110 transition-all duration-300 animate-pulse-green min-w-[48px] min-h-[48px]">
        {/* WhatsApp SVG Icon */}
        <svg width="26" height="26" viewBox="0 0 24 24" fill="white" className="sm:w-8 sm:h-8">
