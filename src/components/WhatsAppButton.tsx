...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/50 hover:scale-110 transition-all duration-300 animate-pulse-gold-green min-w-[48px] min-h-[48px]">
