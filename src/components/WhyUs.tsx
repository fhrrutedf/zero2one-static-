...
export default function WhyUs() {
  ...
  return (
    <section id="whyus" ref={sectionRef} className="py-14 sm:py-20 lg:py-28 bg-white">
          ...
          {features.map((feature, idx) => {
            ...
            return (
              <div
                ...
                className={`card-hover text-center p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-card-bg ${visible ? 'animate-fade-in-up' : 'opacity-0'}`}
                style={{ animationDelay: `${idx * 100}ms` }}
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 sm:mb-6 rounded-full bg-gradient-to-br from-gold/20 to-violet/10 flex items-center justify-center">
                  <Icon size={22} className="text-gold sm:w-7 sm:h-7" />
                </div>
